...
// WiFi Credentials
const char* ssid = "Raj 2G";       // Replace with your WiFi SSID
const char* password = "9717123767@"; // Replace with your WiFi password

// Sinric Pro Credentials
const char* appKey = "9e42eae9-9139-4527-828f-bfeb4185f20f";    // Replace with your Sinric Pro App Key
const char* secretKey = "28450237-0847-464a-a286-e27651ff6f37-0ddee04a-1d03-4854-87e7-368ac088c8b3"; // Replace with your Sinric Pro Secret Key
const char* switch1_ID = "6786618113f98f141625e814"; // Replace with Switch 1 ID
const char* switch2_ID = "6786619e13f98f141625e83f"; // Replace with Switch 2 ID
